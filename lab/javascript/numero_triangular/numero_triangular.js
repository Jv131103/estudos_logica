function is_triangular(n){
    ...
    */
    let delta = 8 * n + 1;  // Discriminante da fórmula de Bhaskara: Δ = b² - 4ac

    // Calcula a raiz quadrada de delta
    let raiz = delta ** (1/2);

    // Arredonda a raiz para inteiro (para testar se é uma raiz exata)
    let raiz_arredondada = parseInt(raiz);
    ...
    */
    ...
    let resultado = (-1 + raiz_arredondada) / 2;
...
console.log(is_triangular(120));
console.log(is_triangular(23));
